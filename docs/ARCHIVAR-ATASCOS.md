...
Apúntala tú en `docs/COLA.md` como **fila 43** (el número 33 ya lo lleva `TABLON-NO-SE-BORRA.md`,
que se coló delante). Cámbiala a EN CURSO en tu primer commit, y márcala HECHA al terminar.
