...
| `PLANTILLAS/` | Los `.docx` que Francisco sube a mano, colgados de un tipo desde Ajustes › Plantillas de documento. También `membrete.png` (fila 81): la única imagen que escribe la propia aplicación ahí, desde Ajustes → El centro → Membrete. No lleva copia de seguridad: no es uno de los diecisiete ficheros compartidos |
