...
- Plantillas de correo y de Séneca, con huecos que se rellenan solos (botón "Insertar hueco" con
  buscador, al escribir una); firma y datos del centro se editan en Ajustes.
