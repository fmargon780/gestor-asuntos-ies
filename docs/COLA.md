...
| 170 | `docs/PLANTILLAS-DEL-COMPANERO.md` (50 plantillas ya escritas —34 de documento y 16 de correo— sacadas de los documentos del compañero, las escribe `docs/plantillas-nuevas/generar.py` en `plantillas/`; texto propio para Séneca en los correos; quitar el saludo repetido de los correos de antes; tipos y campos nuevos en la biblioteca; la Consejería por defecto) | PENDIENTE |
