...
| 6 | `docs/AJUSTES-AGIL.md` | PENDIENTE | Apuntada 11-sep-2026 · 13:05. Crear tipos en Ajustes sin scroll: la lista obedece a la categoría elegida, pestañas con la cuenta de cada una, buscador que mira en las cuatro categorías, aviso en vivo si el nombre ya existe o se parece, los tipos en rejilla de tres columnas y Ajustes con todo el ancho. Y la barra de la izquierda quieta, con Ajustes arriba entre las pestañas y una rueda dentada cuando está plegada |
