...
|---|---|---|
| 90 | `docs/ARCHIVAR-SIN-AVISOS-FALSOS.md` (al archivar desde la ficha salen dos avisos rojos sobrantes, uno en inglés; reintentar las escrituras que tropiezan con Dropbox) | EN CURSO (21-sep-2026) |
...
**La 88 está HECHA** (21-sep-2026, `App.VERSION`: `21-sep-2026 · 07:17`). La 63, la 76 y ahora
también la 89 están BLOQUEADAS y no se retoman sin que Francisco lo diga (la 89, en cuanto haya
creado el repositorio público y el secreto `COPIA_TOKEN`, ver `docs/CLAVE-COPIA-PUBLICA.md`). La
