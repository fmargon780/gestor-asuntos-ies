...
| 16 | `docs/QUE-ME-TOCA.md` | EN CURSO (16-sep-2026) | Pantalla nueva que cruza todos los asuntos abiertos: "En tu tejado", "Esperando a otros" (con días parados) y "Sin fecha", con filtro por responsable. Depende de la fila 15 (ya HECHA). Acordado con Francisco el 16-sep-2026. |
