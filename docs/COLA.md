...
| 4 | `docs/TERCEROS-RELACIONADOS.md` | PENDIENTE | Terceros relacionados con un asunto: se eligen en la ficha, y al archivar queda una carpeta marcador `… (RELACIONADO)` en el archivo de cada uno, con un aviso dentro que dice dónde está la carpeta buena. No se copian documentos. Se quitan al reabrir. Diseño cerrado con Francisco el 11-sep-2026 |
