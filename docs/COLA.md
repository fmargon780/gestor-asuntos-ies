...
Las filas 1 a 62, 64 a 75, 77 a 101 están **HECHAS**. Sus documentos siguen en
`docs/`, y el detalle de cada una en `docs/HISTORIA.md`. Aquí queda solo lo que no está cerrado:

| Nº | Instrucción | Estado |
|---|---|---|
| 102 | `docs/DOCUMENTOS-DESDE-EL-HITO.md` (plantillas de documento unidas a un paso o modelo de la biblioteca; "Generar documento" dentro del hito, que lo deja apuntado a él; huecos del hito). Después de la 101 | EN CURSO (23-sep-2026) |
