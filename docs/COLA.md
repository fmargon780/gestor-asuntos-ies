...
| 12 | `docs/DOCUMENTO-A-ASUNTO-EXISTENTE.md` | EN CURSO (16-sep-2026) | Botón "Meter en un asunto" en Por clasificar, para mandar un documento suelto a un asunto que ya existe. Comparte el elegidor de asuntos con la fila 11 (`js/bandeja-enlace.js`). Acordado con Francisco el 16-sep-2026. |
