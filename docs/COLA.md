...
| 12 | `docs/DOCUMENTO-A-ASUNTO-EXISTENTE.md` | EN CURSO | Empezada el 16-sep-2026 (la fila 11 sigue EN CURSO de otra sesión, así que el elegidor de asuntos nace en solitario en `js/elegir-asunto.js`; cuando la 11 se retome, que reutilice este módulo). |
