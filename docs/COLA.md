...
| 7 | `docs/PAPELERA.md` | EN CURSO | Empezada 11-sep-2026 · 14:25 (sesión programada) |
| 8 | `docs/UNIR-VER-DENTRO.md` | PENDIENTE | Apuntada 11-sep-2026, corregida el mismo día: las franjas amarillas salen de la lista de abiertos y dejan ahí solo un aviso de una línea ("⚠ 3 posibles duplicados — Revisar"), porque le tapaban sus asuntos. La comparación se va a una pantalla propia: los asuntos en columnas con fecha, estado, vía, documentos y notas; los documentos se abren en el panel de la derecha con el visor que ya existe; botones Unir y "No son el mismo", este último guardado en `_GESTOR/no-duplicados.json` con vuelta atrás desde Ajustes › Duplicados descartados |
