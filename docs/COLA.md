...
| 24 | `docs/NO-PISARSE-EN-UN-ASUNTO.md` | EN CURSO (17-sep-2026) | **La tercera, después de la 25.** Acordado con Francisco el 17-sep-2026. Señal de presencia en `_GESTOR/presencia.json`: al abrir la ficha de un asunto se apunta quién está dentro, se renueva cada 30 segundos y caduca a los 3 minutos. Si el otro ya está dentro, se entra **en modo consulta** (se ve todo, los botones que modifican salen apagados) con aviso arriba y botón "Tomar el mando". Marca en la tarjeta de la lista. Descartado, por ahora, montar una base de datos en internet para que el aviso fuera instantáneo. No toca el script de Apps Script. |
