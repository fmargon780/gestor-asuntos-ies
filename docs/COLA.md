...
|---|---|---|
| 91 | `docs/COPIA-SE-ACTUALIZA.md` (la copia sin internet se queda en la versión vieja sin avisar: franja con «Actualizar ahora», el instalador guarda siempre la carpeta y rescata copias viejas; y cerrar la 89) | EN CURSO (23-sep-2026) |
