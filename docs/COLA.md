...
| 177 | `docs/ARCHIVO-POR-CURSO-Y-RUTAS.md` (tanda de estabilidad, parte 2: índice del ARCHIVO en un fichero por curso académico con resumen en la raíz, migración sola, selector «Curso» en Archivo; los topes de largo cuentan la ruta completa dentro de Dropbox y avisan de lo que ya se pasa; después de la 176) | PENDIENTE (26-sep-2026). Otra sesión la marcó EN CURSO por error sin empezarla de verdad; vuelve a PENDIENTE porque otra conversación distinta ya la está trabajando de verdad desde antes |
