...
| 15 | `docs/HITOS.md` | EN CURSO (16-sep-2026) | Hitos dentro de cada asunto: los pasos de la guía pasan a ser hitos vivos, con estado, fecha, responsable, notas y documentos apuntados. Fichero nuevo `_GESTOR/hitos.json` (los compartidos pasan de once a doce); al archivar, el historial se escribe en la carpeta del asunto. Bifurcaciones como hito de decisión. Responsables configurables más papeles automáticos. Plazos en días hábiles. Acordado con Francisco el 16-sep-2026. |
