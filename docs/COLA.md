...
| 12 | `docs/DOCUMENTO-A-ASUNTO-EXISTENTE.md` | HECHA | Terminada 16-sep-2026. Botón "Meter en un asunto" en cada documento de Por clasificar, entre "Crear asunto con él" y "Borrar": lleva el papel a la carpeta de un asunto que ya existe y abre el cuadro de ponerle nombre. El cuadro de escoger asunto sale de `js/bandeja-enlace.js` a `js/elegir-asunto.js` y lo comparten la bandeja de correos y Por clasificar; cada uno conserva su propia puntuación de "Podrían encajar". Si ya hay un fichero con ese nombre no se pisa, y si el traslado falla el documento sigue en Por clasificar. Batería completa (`npm test`, 20 ficheros de prueba) en verde, con `pruebas/documentos-sueltos.mjs` nueva. Versión publicada y comprobada con `curl`: `16-sep-2026 · 21:40`. Detalle en `docs/HISTORIA.md`. |
| 13 | `docs/ADJUNTAR-DOCUMENTOS-AL-CORREO.md` | EN CURSO (16-sep-2026) | Mandar los documentos de un asunto por correo: se eligen con casillas en el cuadro "Correo", y el script de Apps Script deja un borrador en Gmail con todo adjuntado. Responde dentro del hilo si el asunto ya tiene uno. Ya tiene la huella del hilo de la fila 11. Acordado con Francisco el 16-sep-2026. |
