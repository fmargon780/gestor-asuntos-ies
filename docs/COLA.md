...
| 125 | `docs/BUSCAR-PERSONAS-Y-FAMILIAS.md` (Personas y empresas: matriculados primero y antiguos plegados, buscar por padre/madre/tutor legal con sus hijos, ficha fija al bajar y hermanos en el centro) | PENDIENTE |
