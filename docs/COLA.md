...
|---|---|---|
| 89 | `docs/COPIA-SIN-INTERNET.md` (copia de la aplicación en Dropbox que se abre sin internet, porque el filtro del instituto corta asuntos.fmargon.com) | EN CURSO (21-sep-2026) |
...
BLOQUEADAS y no se retoman sin que Francisco lo diga. La 89 está EN CURSO (21-sep-2026). La tabla está en orden de trabajo, no de número, así que en cuanto se apunte una fila nueva,
