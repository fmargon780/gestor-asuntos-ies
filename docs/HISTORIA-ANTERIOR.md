# Historia anterior (hasta el 17-sep-2026)

Documento hijo de `docs/HISTORIA.md` (fila 65, `docs/DOCUMENTOS-QUE-QUEPAN.md`, 19-sep-2026): el diario vivo se corta cuando pasa de 60 KB, quedándose con lo más reciente; lo anterior se mueve aquí tal cual, sin resumir, y **este documento no se vuelve a tocar**. Contenido íntegro y en el mismo orden que tenía en `docs/HISTORIA.md` antes del corte (de lo más nuevo de esta tanda a lo más viejo).
