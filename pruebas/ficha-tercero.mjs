...
{
  const alumno = {
    nombre: 'Ejemplo Prueba, Alumno', id: '1234567', categoria: 'ALUMNADO', ano: 2026,
    matriculado: true, unidad: '3º ESO A', curso: '3º de E.S.O.', fechaNac: fechaParaEdad(13),
    campos: {
      'Sexo': 'H',
      'Teléfono': '600000001',
      'Teléfono personal': '600 000 001',
      'Correo electrónico personal': 'alumno.ejemplo@ejemplo.invalid',
      'Primer apellido Primer tutor': 'Modelo',
      'Segundo apellido Primer tutor': 'Muestra',
      'Nombre Primer tutor': 'Tutora Uno',
      'Sexo Primer tutor': 'M',
      'Teléfono Primer tutor': '600000001',
      'Primer apellido Segundo tutor': 'Ejemplo',
      'Segundo apellido Segundo tutor': 'Padre',
      'Nombre Segundo tutor': 'Tutor Dos',
      'Sexo Segundo tutor': 'H',
      'Correo electrónico Segundo tutor': 'tutor.dos@ejemplo.invalid'
    }
  };
  const tutores = Datos.tutoresDe(alumno);
  comprobar('9. dos tutores, cada uno con su nombre entero',
    tutores.map((t) => [t.numero, t.nombre, t.sexo, t.iniciales]),
    [[1, 'Tutora Uno Modelo Muestra', 'M', 'TU'], [2, 'Tutor Dos Ejemplo Padre', 'H', 'TD']]);
  ...
  comprobar('9. la cabecera, con el nombre en orden natural',
    caja.querySelector('.vt-nombre').textContent, 'Alumno Ejemplo Prueba');
  ...
  comprobar('9. los tutores, con su nombre y su etiqueta',
    ...
    [['Tutora Uno Modelo Muestra', 'Tutora 1'], ['Tutor Dos Ejemplo Padre', 'Tutor 2']]);
  ...
  comprobar('9. el teléfono del alumno, una sola vez y en grupos de tres',
    Array.from(telAlumno).map((d) => d.querySelector('.vt-valor').textContent), ['600 000 001']);
  ...
  comprobar('9. «Copiar todo el contacto», una línea por persona', v.textoDeTodo(), [
    'Alumno Ejemplo Prueba (3º ESO A) · 600000001 · alumno.ejemplo@ejemplo.invalid',
    'Tutora 1: Tutora Uno Modelo Muestra · 600000001',
    'Tutor 2: Tutor Dos Ejemplo Padre · tutor.dos@ejemplo.invalid'].join('\n'));
}
