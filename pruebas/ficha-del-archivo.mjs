...
for (const f of ['util.js', 'util-parecidos.js', 'util-pantalla.js', 'reintentar-escritura.js', 'carpetas.js', 'copias.js', 'nucleo.js', 'asuntos-archivar.js', 'ficha-archivo.js']) {
