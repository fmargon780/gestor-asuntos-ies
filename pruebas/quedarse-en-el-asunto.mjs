...
await pagina.waitForSelector('.hito-doc-anadir:not(.oculto)');
await laFilaDelHito.locator('.hito-doc-anadir').click();
await laFilaDelHito.locator('.hito-anadir-carpeta').click();   /* fila 103: el menú de «Añadir documento» */
