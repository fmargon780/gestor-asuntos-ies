...
for (const f of ['util.js', 'util-parecidos.js', 'util-pantalla.js', 'reintentar-escritura.js', 'carpetas.js', 'copias.js', 'guias.js', 'hitos.js', 'hitos-archivo.js', 'hitos-requisitos.js']) {
